...
## 2026-09-17：合并上游 0.69.0

合并上游 `47311de`，保留个人分支功能：附件加号与 HTTP 上传、GPT-6 Astra、子代理状态与模型、消息编辑修订、对话用时与时间、拖动排序、提问等待与自定义回答、通知、局域网监听及 Token 链接。
升级前代码保存在 `backup/sam-upgrade-before-069-20260917`。部署继续等待任务空闲，保留本机配置、Playwright MCP、附件和任务记录；部署备份现在包含 package.json，版本号随代码更新。
